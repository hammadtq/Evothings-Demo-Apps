...
//This function submits the data to Artik cloud
function startPush() {

	//Please provide your own Artik details below
	var device_id = "xxxxxxxxxxxxxxxxx"; //device id
	var oauth_token = "xxxxxxxxxxxxxxxxxxxx"; //generated from API console (https://developer.artik.cloud/api-console/)
	var evt = {temperature: lastTemperatureReading, humidity: lastHumidityReading, luxometer: lastLightReading}
	
	cordovaHTTP.postJson("https://api.artik.cloud/v1.1/messages", {
